...
```
<P>_NOTE: Block #0 secures the first five messages of doctor and has a pointer to null_
Block #:0
...
Decrypted message: P: Sure, I'm I'm just having a lot of chest pain and and so I thought I should get it checked out.</P>
```
### Comparsions with RSA:
After our research and testing we found that ECDSA is has 1/4th of the hash value as RSA, and is almost 3 times faster and more randomized.
